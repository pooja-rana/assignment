...
from .services.password_reset_email_services import PasswordReset
...
#             PasswordReset.send_password_reset_email.delay(redirect_url, current_site, user_id)
#
...
#                 # return Response({"success": True, "message": "Credentials valid", "uidb64": uidb64, "token":
